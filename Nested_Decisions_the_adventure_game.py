...
if place == "forest":
    ...
    if action == "light a torch":
        print("You found ancient cave paintings!")
    elif action == "proceed in the dark":
        print("you walk straight into the cave wall, ouch!")

# Task 3: Default Path

# If the user makes an invalid choice at any point, incorporate a pass statement to 
# handle it. HINT: How can an else statement be of use here?
